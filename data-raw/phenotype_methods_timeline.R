# Build phenotype_methods_timeline dataset from phenotype-mapping-methods.md
# comparison table (OpenAlex snapshot, 9 Jul 2026).
...
phenotype_methods_timeline <- data.frame(
  date = as.Date(c(
    ...
    "2025-08-01", "2025-08-01", "2025-08-01", "2025-06-01", "2025-04-01",
    "2025-03-01", "2024-11-01", "2024-08-01", "2024-05-01", "2024-05-01",
    "2024-04-01", "2023-11-01", "2023-07-01", "2023-05-01", "2023-03-01",
    "2022-11-01", "2022-02-01", "2021-11-01", "2020-08-01", "2020-07-01"
  )),
  topic = c(
    ...
    "CellPhenoX", "SCTP", "scBGDL", "ATSDP-NET", "SpaLinker",
  ...
  category = c(
    ...
    "spatial+bulk", "sc cohort", "bulk+sc", "bulk+sc", "bulk+sc",
    "bulk+sc", "bulk+sc", "sc cohort", "bulk+sc", "bulk+sc", "sc cohort",
    "bulk+sc", "bulk+sc", "bulk+sc", "bulk+sc", "bulk+sc", "sc cohort"
  ),
  status = c(
    ...
    "peer-reviewed", "peer-reviewed", "peer-reviewed", "peer-reviewed",
    "peer-reviewed", "peer-reviewed", "peer-reviewed", "preprint",
    "peer-reviewed", "peer-reviewed", "peer-reviewed", "peer-reviewed",
    "peer-reviewed", "peer-reviewed", "peer-reviewed", "peer-reviewed",
    "peer-reviewed", "peer-reviewed", "peer-reviewed", "peer-reviewed",
  ...
  citations = c(
    ...
    0L, 0L, 2L, 0L, 3L, 2L, 6L, 1L, 3L, 3L, 13L, 7L, 2L, 6L, 9L, 3L,
    5L, 12L, 13L, 7L, 35L, 49L, 520L, 24L, 40L
  ),
