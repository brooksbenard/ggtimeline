...
#'
#' @format A data frame with 41 rows and 5 columns:
#' \describe{
...
#'   \item{citations}{OpenAlex citation count (retrieved 14 Jul 2026).}
#' }
...
#'   (local snapshot: `data-raw/phenotype-mapping-methods.html`).
#' @examples
